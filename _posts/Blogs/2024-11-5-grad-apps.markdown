---
layout: archive
title:  "PhD Application Insight and Advice"
...
- [My statement of purpose for UCLA](/assets/files/ucla_statement_of_purpose.pdf)
- [My personal history statement for Berkeley](/assests/files/berkeley_personal_history.pdf)
...
1. **Admitted to a PhD program with funding**: This is what you want. This means that the school/advisor has resources and is willing to invest those resources in you. Generally this funding lasts a year to a couple of years and then you'll be funded off of other things like grants or industry collaborations.
2. **Admitted to a master's program with potential for PhD**: This is kind of a middle ground. Some of the more traditional, prestigious programs do this. Be careful. If the master's is funded, then it's not necessarily a bad sign, but check to see how hard it is to convert from a master's student to a PhD student. 
3. **Admitted with no funding**: This is generally bad. You should **not** enroll in a PhD program that you have to pay for. And more generally, you should not be paying to do research. 
